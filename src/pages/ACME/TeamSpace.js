...
import TeamSpaceTable from "../../components/Tables/TeamSpaceTable";
import TeamSpaceHeader from "../../components/TeamSpace/TeamSpaceHeader";
import TeamSpaceFileUpload from "../../components/TeamSpace/TeamSpaceFileUpload";
import TeamSpaceFolderCreate from "../../components/TeamSpace/TeamSpaceFolderCreate";
...
const TeamSpace = () => {
  ...
  const getSharedFile = () => {
    getsharedfile(
      {},
      (apiRes) => {
        setSharedFile(apiRes?.data?.mergedData);
      },
      (apiErr) => {
        console.log(apiErr);
      }
